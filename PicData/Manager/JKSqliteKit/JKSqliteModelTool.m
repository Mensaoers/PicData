...
/**
 ...
 @return 返回一个结果
 */
+ (NSArray *)queryDataModel:(Class)cls whereStr:(NSString *)condition uid:(NSString *)uid{
...
/**
 ...
 @return 返回结果
 */
+ (NSArray *)queryDataModel:(Class)cls columnName:(NSString *)name relation:(ColumnNameToValueRelationType)relation value:(NSString *)value uid:(NSString *)uid{
